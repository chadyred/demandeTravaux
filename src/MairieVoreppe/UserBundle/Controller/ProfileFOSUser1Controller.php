...
namespace MairieVoreppe\UserBundle\Controller;

//On hérite de notre RegistrationControler puis on va pouvoir ainsi ajouter d'autres action si on le désire
...
class ProfileFOSUser1Controller extends BaseController
{
    ...
    public function editProfileAction()
    {
        ...
        //edit inclus edit_profile.html.twig qui traite le formulaire
        return $this->render('SonataUserBundle:Profile:edit.html.twig', array(
            'form'               => $form->createView(),
